...
> **2026-09-15 콘텐츠 강화본입니다.** 마이터 어택 기반 탐지·크리덴셜 스터핑 대응·“AI 공격을 AI가 방어합니다”를 메인과 상세 페이지에 반영했습니다. 최근 글자 크기 조정을 포함한 CSS·JavaScript는 원본 그대로입니다. 상세 변경 및 적용 방법은 `CONTENT-UPDATE-20260915.md`, 이번 검토 범위는 `QA-REPORT.md`를 확인하세요.


**확정 디자인: A안 · Enterprise Blue / 화이트·블루**  
**홈페이지 빌드: 7.1.1-20260915-content**  
...
PLURA-Website-v7.1/
  ...
  previews/                  최신 content-20260915 / 이전 baseline-20260914
  qa/                        최신 content-20260915-full.json / 이전 baseline-20260914
...
| 위협 대응 | `ko/underattack.html` | 크리덴셜 스터핑·계정 탈취 |
...
| 기술 상세 | `ko/mitreattack.html` | 마이터 어택 기반 탐지 |
...
리소스 경로를 `res/v7.1/`로 분리했고 CSS·JS 주소에 빌드 쿼리 `?v=7.1.1-20260915-content`를 붙였습니다. 이전 v7.0 CSS와 혼용하거나 예전 시안 탭을 다시 열지 않도록 새 폴더에서 확인하세요.
